...
class TTextFormFieldTheme {
  ...
  static InputDecorationTheme lightInputDecorationTheme = InputDecorationTheme(
    ...
    labelStyle: const TextStyle().copyWith(fontSize: 16.sp, color: TColors.black),
    hintStyle: const TextStyle().copyWith(fontSize: 12.sp, color: TColors.black),
  ...
  static InputDecorationTheme darkInputDecorationTheme = InputDecorationTheme(
    ...
    suffixIconColor: TColors.darkGrey,
    // constraints: const BoxConstraints.expand(height: TSizes.inputFieldHeight),
    labelStyle: const TextStyle().copyWith(fontSize: 16.sp, color: TColors.white),
    hintStyle: const TextStyle().copyWith(fontSize: 12.sp, color: TColors.white),
