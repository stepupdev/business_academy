...
class Topic {
  ...
  Topic({this.id, this.name, this.icon, this.createdAt, this.updatedAt, this.postsCount});
...
class User {
  ...
  factory User.fromJson(Map<String, dynamic> json) => User(
    ...
    email: json["email"],
    avatar: json["avatar"],
    communityIds: json["community_ids"],
...
class Rank {
  ...
  Rank({this.id, this.name, this.position, this.createdAt, this.updatedAt});
