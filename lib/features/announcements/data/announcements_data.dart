...
AnnouncementPostResponseModel announcementPostResponseModelFromJson(String str) =>
    AnnouncementPostResponseModel.fromJson(json.decode(str));
...
class AnnouncementPostResponseModel {
  ...
  AnnouncementPostResponseModel({this.success, this.message, this.result});
